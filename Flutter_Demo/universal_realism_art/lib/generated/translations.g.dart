...
///
/// Locales: 2
/// Strings: 805 (402 per locale)
///
/// Built on 2024-02-07 at 14:49 UTC
...
class _TranslationsMobileScreensRu {
	...
	late final _TranslationsMobileScreensTopicsRu topics = _TranslationsMobileScreensTopicsRu._(_root);
...
class _TranslationsModalRu {
	...
	late final _TranslationsModalDecisionMessageCardIssueRu decisionMessageCardIssue = _TranslationsModalDecisionMessageCardIssueRu._(_root);
...
class _TranslationsExceptionsRu {
	...
	String get emtyMainProduct => 'Отсутствует карта или номер счёта, пожалуйста добавьте или сделайте основным карту или счёт во вкладке продукты';
...
class _TranslationsMobileScreensAuthPasswordResetRu {
	...
	String get communicationSource => 'Источник коммуникации из профиля';
	String get resetButton => 'Сменить';
	String get login => 'Логин';
	String get phoneNumber => 'Номер телефона';
	String get loginHint => 'Ваш логин';
	String get success => 'Успешно';
	String get message => 'Новый пароль выслан на источник коммуникации из профиля';
...
// Path: mobileScreens.topics
class _TranslationsMobileScreensTopicsRu {
	_TranslationsMobileScreensTopicsRu._(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	String get graphics => 'Графика';
	String get portrait => 'Потрет';
	String get landscape => 'Пейзаж';
	String get stillLife => 'Натюрморт';
	String get mosaic => 'Мозайка';
	String get tapestry => 'Гобелен';
}
...
class _TranslationsMobileScreensQrPaymentRu {
	...
	// Translations
	String get p2PPaymentButton => 'P2P перевод';
	String get p2PpaymentSum => 'Сумма перевода';
	String get p2PAmountError => 'Сумма платежа должна быть больше 0';
	String get p2PDialogTitle => 'Перевод средств';
	String get confirmButtonTitle => 'Подтвердить';
	String get cancelButtonTitle => 'Отменить';
	String get applyButton => 'Применить';
	String get tranferHistory => 'Выписка';
	String get hitorySearchResult => 'Результат поиска:';
	String get historyIsEmpty => 'История операций пуста';
	String get generateQrButton => 'Получить QR';
	String get updateQrButton => 'Обновить QR';
	String get confirmOrderBySMS => 'Подтвердить СМС';
	String get qrPaymentTitle => 'QR оплата';
	String get qrPaymentDecisionTitle => 'Перейти к оплате платежа?';
	String get historyDialogTitle => 'QR операция';
	String get paymentCanceledDialog => 'Платёж отменён';
...
class _TranslationsMobileScreensProfileRu {
	...
	late final _TranslationsMobileScreensProfileAboutAppItemRu aboutAppItem = _TranslationsMobileScreensProfileAboutAppItemRu._(_root);
	String version({required Object version}) => 'Версия${version}';
	String get contactMessage => 'Связаться с нами';
...
class _TranslationsMobileScreensProfileEditRu {
	...
	late final _TranslationsMobileScreensProfileEditEmailValidatorRu emailValidator = _TranslationsMobileScreensProfileEditEmailValidatorRu._(_root);
...
class _TranslationsMobileScreensMdomAccountAddRu {
	...
	late final _TranslationsMobileScreensMdomAccountAddSupplierNameFieldRu supplierNameField = _TranslationsMobileScreensMdomAccountAddSupplierNameFieldRu._(_root);
}
...
class _TranslationsMobileScreensMdomPollsListRu {
	...
	String get noMoreDataMessage => 'Все загружено';
...
class _TranslationsMobileScreensMdomPollRu {
	...
	String pollStatButton({required num n, required Object count}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ru'))(n,
...
class _TranslationsModalPinVerifyRu {
	...
	String get decisionMessageTitle => 'Для смены PIN-кода повторите авторизацию';
	String get forgetPinButton => 'Забыли PIN-код?';
	String get cancelButton => 'Отмена';
...
// Path: modal.decisionMessageCardIssue
class _TranslationsModalDecisionMessageCardIssueRu {
	_TranslationsModalDecisionMessageCardIssueRu._(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	String get confirmButton => 'Продолжить';
...
class _TranslationsMobileScreensAuthPasswordResetErrorsRu {
	...
	String get phoneLength => 'Минимальная длина телефона не подходит';
}
...
class _TranslationsMobileScreensPaymentFieldsPageRu {
	...
	late final _TranslationsMobileScreensPaymentFieldsPageQrPayVerifyDataRu qrPayVerifyData = _TranslationsMobileScreensPaymentFieldsPageQrPayVerifyDataRu._(_root);
	String get nextButton => 'Далее';
	String get finishButton => 'Закрыть';
}
...
// Path: mobileScreens.profile.aboutAppItem
class _TranslationsMobileScreensProfileAboutAppItemRu {
	_TranslationsMobileScreensProfileAboutAppItemRu._(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	String get title => 'О приложении';
}
...
// Path: mobileScreens.profileEdit.emailValidator
class _TranslationsMobileScreensProfileEditEmailValidatorRu {
	_TranslationsMobileScreensProfileEditEmailValidatorRu._(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	String get invalidEmail => 'Неправильный формат email';
	String get invalidLength => 'Email слишком длинный';
	String get emptyEmail => 'Поле email не заполнено';
}
...
class _TranslationsMobileScreensSettingsSectionsRu {
	...
	late final _TranslationsMobileScreensSettingsSectionsNotificationMethodRu notificationMethod = _TranslationsMobileScreensSettingsSectionsNotificationMethodRu._(_root);
}
...
class _TranslationsMobileScreensQrScanModalRu {
	...
	// Translations
	late final _TranslationsMobileScreensQrScanModalConfirmationRu confirmation = _TranslationsMobileScreensQrScanModalConfirmationRu._(_root);
...
// Path: mobileScreens.mdomAccountAdd.supplierNameField
class _TranslationsMobileScreensMdomAccountAddSupplierNameFieldRu {
	_TranslationsMobileScreensMdomAccountAddSupplierNameFieldRu._(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	String get title => 'Наименование организации';
	late final _TranslationsMobileScreensMdomAccountAddSupplierNameFieldErrorsRu errors = _TranslationsMobileScreensMdomAccountAddSupplierNameFieldErrorsRu._(_root);
}
...
// Path: mobileScreens.payment.fieldsPage.qrPayVerifyData
class _TranslationsMobileScreensPaymentFieldsPageQrPayVerifyDataRu {
	_TranslationsMobileScreensPaymentFieldsPageQrPayVerifyDataRu._(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	String get title => 'Введите недостающие данные';
	String get checkTitle => 'Детали операции:';
...
class _TranslationsMobileScreensProfileEditModalSuccessRu {
	...
	// Translations
	String get title => 'Успешно';
	String get message => 'Пользователь отредактирован';
}
...
class _TranslationsMobileScreensSettingsSectionsAccountRu {
	...
	String get notification => 'Способ оповещения';
...
// Path: mobileScreens.settings.sections.notificationMethod
class _TranslationsMobileScreensSettingsSectionsNotificationMethodRu {
	_TranslationsMobileScreensSettingsSectionsNotificationMethodRu._(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	String get title => 'Выберите способ оповещения';
	String get text => '';
	String get success => '';
}
...
// Path: mobileScreens.qrScan.modal.confirmation
class _TranslationsMobileScreensQrScanModalConfirmationRu {
	_TranslationsMobileScreensQrScanModalConfirmationRu._(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	String get accountNumber => 'Номер счета';
	String get eripCode => 'Код услуги';
	String get summ => 'Сумма';
	String get recieverName => 'Наименование получателя';
}
...
// Path: mobileScreens.mdomAccountAdd.supplierNameField.errors
class _TranslationsMobileScreensMdomAccountAddSupplierNameFieldErrorsRu {
	_TranslationsMobileScreensMdomAccountAddSupplierNameFieldErrorsRu._(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	String get empty => 'Минимальная длина 3 символа';
}
...
class _TranslationsMobileScreensEn extends _TranslationsMobileScreensRu {
	...
	@override late final _TranslationsMobileScreensTopicsEn topics = _TranslationsMobileScreensTopicsEn._(_root);
...
class _TranslationsModalEn extends _TranslationsModalRu {
	...
	@override late final _TranslationsModalDecisionMessageCardIssueEn decisionMessageCardIssue = _TranslationsModalDecisionMessageCardIssueEn._(_root);
...
class _TranslationsExceptionsEn extends _TranslationsExceptionsRu {
	...
	@override String get emtyMainProduct => 'Missing card or account number, please add or make the main card or account in the products tab';
...
class _TranslationsMobileScreensAuthPasswordResetEn extends _TranslationsMobileScreensAuthPasswordResetRu {
	...
	@override String get communicationSource => 'Source of communication from profile';
	...
	@override String get message => 'A new password has been sent to the source of communication from the profile';
...
// Path: mobileScreens.topics
class _TranslationsMobileScreensTopicsEn extends _TranslationsMobileScreensTopicsRu {
	_TranslationsMobileScreensTopicsEn._(_TranslationsEn root) : this._root = root, super._(root);

	@override final _TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get graphics => 'Graphics';
	@override String get portrait => 'Portrait';
	@override String get landscape => 'Landscape';
	@override String get stillLife => 'Still Life';
	@override String get mosaic => 'Mosaic';
	@override String get tapestry => 'Tapestry';
}
...
class _TranslationsMobileScreensQrPaymentEn extends _TranslationsMobileScreensQrPaymentRu {
	...
	// Translations
	@override String get p2PPaymentButton => 'P2P transfer';
	@override String get p2PpaymentSum => 'Transfer amount';
	@override String get p2PAmountError => 'Payment amount must be greater than 0';
	@override String get p2PDialogTitle => 'Money transaction';
	@override String get confirmButtonTitle => 'Confirm';
	@override String get cancelButtonTitle => 'Cancel';
	@override String get applyButton => 'Apply';
	@override String get tranferHistory => 'History';
	@override String get hitorySearchResult => 'Search result:';
	@override String get historyIsEmpty => 'History is empty';
	...
	@override String get qrPaymentDecisionTitle => 'Proceed to payment?';
	@override String get historyDialogTitle => 'QR operation';
	@override String get paymentCanceledDialog => 'Payment canceled';
...
class _TranslationsMobileScreensProfileEn extends _TranslationsMobileScreensProfileRu {
	...
	@override late final _TranslationsMobileScreensProfileAboutAppItemEn aboutAppItem = _TranslationsMobileScreensProfileAboutAppItemEn._(_root);
	@override String version({required Object version}) => 'Version${version}';
	@override String get contactMessage => 'Connect with us';
...
class _TranslationsMobileScreensProfileEditEn extends _TranslationsMobileScreensProfileEditRu {
	...
	@override late final _TranslationsMobileScreensProfileEditEmailValidatorEn emailValidator = _TranslationsMobileScreensProfileEditEmailValidatorEn._(_root);
...
class _TranslationsMobileScreensMdomAccountAddEn extends _TranslationsMobileScreensMdomAccountAddRu {
	...
	@override late final _TranslationsMobileScreensMdomAccountAddSupplierNameFieldEn supplierNameField = _TranslationsMobileScreensMdomAccountAddSupplierNameFieldEn._(_root);
}
...
class _TranslationsMobileScreensMdomPollsListEn extends _TranslationsMobileScreensMdomPollsListRu {
	...
	@override String get noMoreDataMessage => 'All uploaded';
...
class _TranslationsMobileScreensMdomPollEn extends _TranslationsMobileScreensMdomPollRu {
	...
	@override String pollStatButton({required num n, required Object count}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('en'))(n,
...
class _TranslationsModalPinVerifyEn extends _TranslationsModalPinVerifyRu {
	...
	@override String get decisionMessageTitle => 'To change the PIN code, repeat the authorization';
	@override String get forgetPinButton => 'Forgot your PIN?';
	@override String get cancelButton => 'Cancel';
...
// Path: modal.decisionMessageCardIssue
class _TranslationsModalDecisionMessageCardIssueEn extends _TranslationsModalDecisionMessageCardIssueRu {
	_TranslationsModalDecisionMessageCardIssueEn._(_TranslationsEn root) : this._root = root, super._(root);

	@override final _TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get confirmButton => 'Continue';
	@override String get cancelButton => 'Cancel';
}
...
class _TranslationsMobileScreensAuthPasswordResetErrorsEn extends _TranslationsMobileScreensAuthPasswordResetErrorsRu {
	...
	@override String get phoneLength => 'Minimum phone length is not suitable';
}
...
class _TranslationsMobileScreensPaymentFieldsPageEn extends _TranslationsMobileScreensPaymentFieldsPageRu {
	...
	@override late final _TranslationsMobileScreensPaymentFieldsPageQrPayVerifyDataEn qrPayVerifyData = _TranslationsMobileScreensPaymentFieldsPageQrPayVerifyDataEn._(_root);
	@override String get nextButton => 'Further';
	@override String get finishButton => 'Close';
}
...
// Path: mobileScreens.profile.aboutAppItem
class _TranslationsMobileScreensProfileAboutAppItemEn extends _TranslationsMobileScreensProfileAboutAppItemRu {
	_TranslationsMobileScreensProfileAboutAppItemEn._(_TranslationsEn root) : this._root = root, super._(root);

	@override final _TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Application info';
}
...
// Path: mobileScreens.profileEdit.emailValidator
class _TranslationsMobileScreensProfileEditEmailValidatorEn extends _TranslationsMobileScreensProfileEditEmailValidatorRu {
	_TranslationsMobileScreensProfileEditEmailValidatorEn._(_TranslationsEn root) : this._root = root, super._(root);

	@override final _TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get invalidEmail => 'Invalid email format';
	@override String get invalidLength => 'Invalid email length';
	@override String get emptyEmail => 'Email is empty';
}
...
class _TranslationsMobileScreensSettingsSectionsEn extends _TranslationsMobileScreensSettingsSectionsRu {
	...
	@override late final _TranslationsMobileScreensSettingsSectionsNotificationMethodEn notificationMethod = _TranslationsMobileScreensSettingsSectionsNotificationMethodEn._(_root);
}
...
class _TranslationsMobileScreensQrScanModalEn extends _TranslationsMobileScreensQrScanModalRu {
	...
	// Translations
	@override late final _TranslationsMobileScreensQrScanModalConfirmationEn confirmation = _TranslationsMobileScreensQrScanModalConfirmationEn._(_root);
...
// Path: mobileScreens.mdomAccountAdd.supplierNameField
class _TranslationsMobileScreensMdomAccountAddSupplierNameFieldEn extends _TranslationsMobileScreensMdomAccountAddSupplierNameFieldRu {
	_TranslationsMobileScreensMdomAccountAddSupplierNameFieldEn._(_TranslationsEn root) : this._root = root, super._(root);

	@override final _TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Organization name';
	@override late final _TranslationsMobileScreensMdomAccountAddSupplierNameFieldErrorsEn errors = _TranslationsMobileScreensMdomAccountAddSupplierNameFieldErrorsEn._(_root);
}
...
// Path: mobileScreens.payment.fieldsPage.qrPayVerifyData
class _TranslationsMobileScreensPaymentFieldsPageQrPayVerifyDataEn extends _TranslationsMobileScreensPaymentFieldsPageQrPayVerifyDataRu {
	_TranslationsMobileScreensPaymentFieldsPageQrPayVerifyDataEn._(_TranslationsEn root) : this._root = root, super._(root);

	@override final _TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Please enter missing information';
	@override String get checkTitle => 'Operation details:';
...
class _TranslationsMobileScreensSettingsSectionsAccountEn extends _TranslationsMobileScreensSettingsSectionsAccountRu {
	...
	@override String get notification => 'Notification method';
...
// Path: mobileScreens.settings.sections.notificationMethod
class _TranslationsMobileScreensSettingsSectionsNotificationMethodEn extends _TranslationsMobileScreensSettingsSectionsNotificationMethodRu {
	_TranslationsMobileScreensSettingsSectionsNotificationMethodEn._(_TranslationsEn root) : this._root = root, super._(root);

	@override final _TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Choose a notification method';
...
// Path: mobileScreens.qrScan.modal.confirmation
class _TranslationsMobileScreensQrScanModalConfirmationEn extends _TranslationsMobileScreensQrScanModalConfirmationRu {
	_TranslationsMobileScreensQrScanModalConfirmationEn._(_TranslationsEn root) : this._root = root, super._(root);

	@override final _TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get accountNumber => 'Account number';
	@override String get eripCode => 'Service code';
	@override String get summ => 'Summ';
	@override String get recieverName => 'Beneficiary\'s name';
}
...
// Path: mobileScreens.mdomAccountAdd.supplierNameField.errors
class _TranslationsMobileScreensMdomAccountAddSupplierNameFieldErrorsEn extends _TranslationsMobileScreensMdomAccountAddSupplierNameFieldErrorsRu {
	_TranslationsMobileScreensMdomAccountAddSupplierNameFieldErrorsEn._(_TranslationsEn root) : this._root = root, super._(root);

	@override final _TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get empty => 'Minimum length 3 characters';
}
