import 'package:universal_realism_art/config.dart';
...
mixin PrefsKeys {
  ...
  static final isLigthTheme = TypeStoreKey<bool>('isLigthTheme', defaultValue: false);
  static final language = TypeStoreKey<String>('language', defaultValue: CoreConfig.defaultLanguageName);
  static final firstLoad = TypeStoreKey<bool>('firstLoad', defaultValue: true);
}
