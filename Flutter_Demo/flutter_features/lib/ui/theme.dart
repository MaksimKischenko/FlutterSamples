...
class BaseMoneyColors {
  const BaseMoneyColors._();

  static const double opacityFullyOpaque = 1.0;
...
class BaseMoneyTheme {
  ...
  static const _bodyBase = TextStyle(
    ...
    color: BaseMoneyColors.onBackground,
  );
  ...
  static ThemeData light(
    ...
    return ThemeData.from(
      ...
      colorScheme: ColorScheme.light(
        background: background ?? BaseMoneyColors.background,
        onBackground: BaseMoneyColors.onBackground,
        primary: primary ?? BaseMoneyColors.primary,
        onPrimary: BaseMoneyColors.onPrimary,
        outline: BaseMoneyColors.neutral92,
        tertiaryContainer: BaseMoneyColors.tertiaryContainer,
        onTertiaryContainer: BaseMoneyColors.onTertiaryContainer,
        onSurfaceVariant: BaseMoneyColors.onSurfaceVariant,
        error: BaseMoneyColors.error,
        errorContainer: BaseMoneyColors.errorLight,
        onErrorContainer: BaseMoneyColors.errorDark,
        surfaceTint: BaseMoneyColors.surfaceTint,
        tertiary: BaseMoneyColors.yellow,
        primaryContainer: BaseMoneyColors.primaryContainer,
        onPrimaryContainer: BaseMoneyColors.onPrimaryContainer,
        secondary: secondary ?? BaseMoneyColors.secondary,
        secondaryContainer: secondaryContainer ?? BaseMoneyColors.secondaryContainer,
        onSecondaryContainer: BaseMoneyColors.onSecondaryContainer,
      ),
      ...
      splashColor: BaseMoneyColors.splashColor,
      brightness: Brightness.light,
      scaffoldBackgroundColor: BaseMoneyColors.background,
      dialogBackgroundColor: BaseMoneyColors.onPrimary,
      dividerColor: BaseMoneyColors.dividerColor,
      snackBarTheme: context.theme.snackBarTheme.copyWith(
        backgroundColor: BaseMoneyColors.onSurfaceVariant,
      ),
      inputDecorationTheme: const InputDecorationTheme(
        border: OutlineInputBorder(
          borderSide: BorderSide(color: BaseMoneyColors.onPrimary),
        ...
        errorBorder: OutlineInputBorder(
          borderSide: BorderSide(color: BaseMoneyColors.error),
          borderRadius: KSize.defaultBorderRadius,
        ),
        ...
        fillColor: BaseMoneyColors.onPrimary,
        filled: true,
      ),
      filledButtonTheme: FilledButtonThemeData(
        style: FilledButton.styleFrom(
          ...
          disabledBackgroundColor: BaseMoneyColors.tertiaryContainer,
        ),
      ),
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          elevation: KSize.elevationDefault,
          disabledBackgroundColor: BaseMoneyColors.tertiaryContainer,
          backgroundColor: BaseMoneyColors.primary,
          foregroundColor: BaseMoneyColors.onPrimary,
        ),
      ),
      appBarTheme: AppBarTheme(
        backgroundColor: background ?? BaseMoneyColors.background,
        iconTheme: const IconThemeData(color: BaseMoneyColors.onBackground),
      ),
    );
  }
}

class BaseMoneyCustomTheme extends StatelessWidget {
  const BaseMoneyCustomTheme({
    this.themeData,
  ...
  Widget build(BuildContext context) {
    return Theme(
      data: themeData ?? BaseMoneyTheme.light(context),
      child: Builder(
        builder: builder,
      ),
    );
